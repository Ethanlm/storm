...
public abstract class Container implements Killable {
    ...
    public void kill() throws IOException {
        ...
        try {
            ...
            if (_resourceIsolationManager != null) {
                _resourceIsolationManager.kill(_workerId, user);
            }
        } catch (IOException e) {
    ...
    public void forceKill() throws IOException {
        ...
        try {
            assert (user != null);
            if (_resourceIsolationManager != null) {
                _resourceIsolationManager.forceKill(_workerId, user);
            }
        } catch (IOException e) {
    ...
    public boolean areAllProcessesDead() throws IOException {
        ...
        if (_resourceIsolationManager != null) {
            String userOfProcess = getRunWorkerAsUser();
            if (runAsUser) {
                userOfProcess = user;
            }
            allDead = _resourceIsolationManager.areAllProcessesDead(_workerId, userOfProcess);
        }
