...
public class DockerRunCommand extends DockerCommand {
     ...
     * @param createSource create source path or not
     * @return the self
     */
     ...
     * @param sourcePath the source path
     * @param destinationPath the destination path
     * @param createSource create the source path or not
     * @return the self
     */
     ...
     * @return the self
     */
    public DockerCommand setCpus(double cpus) {
     ...
     * @return the self
     */
    public DockerCommand setMemoryMb(int memoryMb) {
     ...
     * @return the self
     */
    public DockerCommand setCidFile(String cidFile) {
