...
public class DockerManager implements ResourceIsolationInterface {
    ...
    public void prepare(Map<String, Object> conf) throws IOException {
        ...
        defaultDockerImage = (String) conf.get(DaemonConfig.STORM_DOCKER_DEFAULT_IMAGE);
        if (defaultDockerImage == null || !dockerImagePattern.matcher(defaultDockerImage).matches()) {
            throw new IllegalArgumentException(DaemonConfig.STORM_DOCKER_DEFAULT_IMAGE + " doesn't match " + DOCKER_IMAGE_PATTERN);
        }
        defaultNetworkType = ObjectReader.getString(conf.get(DaemonConfig.STORM_DOCKER_DEFAULT_CONTAINER_NETWORK), "host");
        ...
        memoryCgroupRootPath = cgroupRootPath + "/memory/" + cgroupParent;
    ...
    public void launchWorkerProcess(String user, String workerId, List<String> command, Map<String, String> env,
        ...
        dockerRunCommand.detachOnRun()
            ...
            //for now, just bind mount the entire storm home
            .addMountLocation(stormHome, stormHome, false)
