...
public class DaemonConfig implements Validated {
     ...
     */
    @isString
    public static String STORM_DOCKER_DEFAULT_IMAGE = "storm.docker.default.image";

    /**
     * The default network type for the docker container.
     */
    @isString
    public static String STORM_DOCKER_DEFAULT_CONTAINER_NETWORK = "storm.docker.default.container.network";
